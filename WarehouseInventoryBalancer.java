...
public class WarehouseInventoryBalancer {
     ...
     * Computes section totals, checks balance status, and finds the single highest quantity item.
     *
    ...
    public static void analyzeInventory(int[] sectionA, int[] sectionB) {
        ...
        for (int i = 0; i < sectionB.length; i++) {
            totalB += sectionB[i];
            // If Section B has strictly greater quantity than what was found so far
    ...
    public static void main(String[] args) {
        ...
        // Additional Test Case with Not Balanced status
