 ...
 * different students by mistake — a data-entry slip in the seating spreadsheet could otherwise
 * seat two students in the same chair. The system needs to scan the full list of assigned seat
 * numbers and flag any duplicates before the exam starts.
 *
...
public class ExamHallSeatDuplicationChecker {
    ...
    /**
     * Checks for duplicate seat numbers using nested loops and arrays only (no Collections class).
     *
    ...
    public static void checkDuplicateSeats(int[] seatNumbers) {
        ...
        for (int i = 0; i < seatNumbers.length; i++) {
            // Avoid duplicate printing if this number was already checked
